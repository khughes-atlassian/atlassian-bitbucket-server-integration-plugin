...
public class BitbucketScmHelper {
    ...
    public BitbucketRepository getRepository(String projectName, String repositoryName) {
        if (isBlank(projectName) || isBlank(repositoryName)) {
            ...
            return new BitbucketRepository("", null, new BitbucketProject("", null, ""), "", RepositoryState.AVAILABLE);
        }
        try {
            ...
            return new BitbucketRepository("", null, new BitbucketProject(projectName, null, projectName), "", RepositoryState.AVAILABLE);
